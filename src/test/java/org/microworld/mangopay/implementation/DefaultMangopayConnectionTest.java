...
public class DefaultMangopayConnectionTest {
    ...
    @Test
    public void constructorThrowsExceptionIfHostIsNull() {
    ...
    @Test
    public void constructorThrowsExceptionIfClientIdIsNull() {
        thrown.expect(NullPointerException.class);
    ...
    @Test
    public void constructorThrowsExceptionIfPassphraseIsNull() {
        thrown.expect(NullPointerException.class);
