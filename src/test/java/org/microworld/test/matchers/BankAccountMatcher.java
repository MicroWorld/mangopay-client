...
public class BankAccountMatcher extends TypeSafeDiagnosingMatcher<BankAccount> {
  ...
  private boolean isEqualTo(final BankAccount actual) {
    ...
    if (actual instanceof IbanBankAccount && expected instanceof IbanBankAccount) {
      ...
      if (!IsEqual.equalTo(((IbanBankAccount) expected).getBic()).matches(((IbanBankAccount) actual).getBic())) {
        return false;
      }
      ...
      if (!IsEqual.equalTo(((BritishBankAccount) expected).getSortCode()).matches(((BritishBankAccount) actual).getSortCode())) {
        return false;
      }
      ...
      if (!IsEqual.equalTo(((CanadianBankAccount) expected).getInstitutionNumber()).matches(((CanadianBankAccount) actual).getInstitutionNumber())) {
        return false;
      }
      ...
      if (!IsEqual.equalTo(((UsaBankAccount) expected).getDepositAccountType()).matches(((UsaBankAccount) actual).getDepositAccountType())) {
        return false;
      }
      ...
      if (!IsEqual.equalTo(((OtherBankAccount) expected).getCountry()).matches(((OtherBankAccount) actual).getCountry())) {
        return false;
      }
    }
    return true;
